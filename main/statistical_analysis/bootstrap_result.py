...
if __name__ == "__main__":
    ...
    df_orig = pd.read_csv(os.path.join(
        DATAPATH, "xgb_imputed_test_result.csv"))
    ...
    result.to_csv(os.path.join(
        SAVEPATH, "xgb_imputed_results.csv"), index=False)
    total_result.append(result)
    ...
    df_orig = pd.read_csv(os.path.join(
        DATAPATH, "xgb_fev_fvc_test_result.csv"))
    ...
    result.to_csv(os.path.join(
        SAVEPATH, "xgb_fev_fvc_results.csv"), index=False)
    total_result.append(result)

    df_orig = pd.read_csv(os.path.join(
        DATAPATH, "ann_imputed_test_result.csv"))
    print("ANN Imputed")
    result = calculate_bootstrap_metric(
        df_log=df_orig,
        target="Asthma",
    ...
    result.to_csv(os.path.join(
        SAVEPATH, "ann_imputed_results.csv"), index=False)
    total_result.append(result)
    ...
    df_orig = pd.read_csv(os.path.join(
        DATAPATH, "ann_fev_fvc_test_result.csv"))
    print("ANN FEV_FVC")
    result = calculate_bootstrap_metric(
        df_log=df_orig,
        target="Asthma",
    ...
    result.to_csv(os.path.join(
        SAVEPATH, "ann_fev_fvc_results.csv"), index=False)
    total_result.append(result)

    df_orig = pd.read_csv(os.path.join(
        DATAPATH, "svm_imputed_test_result.csv"))
    print("SVM Imputed")
    result = calculate_bootstrap_metric(
        df_log=df_orig,
        target="Asthma",
    ...
    result.to_csv(os.path.join(
        SAVEPATH, "svm_imputed_results.csv"), index=False)
    total_result.append(result)
    ...
    result.to_csv(
        os.path.join(SAVEPATH, "svm_fev_results.csv"), 
        index=False
    )
    total_result.append(result)

    df_orig = pd.read_csv(
        os.path.join(DATAPATH, "svm_fev_fvc_test_result.csv")
    )
    print("SVM FEV_FVC")
    result = calculate_bootstrap_metric(
        df_log=df_orig,
    ...
    result.to_csv(
        os.path.join(SAVEPATH, "svm_fev_fvc_results.csv"), 
        index=False
    )
    total_result.append(result)

    df_orig = pd.read_csv(
        os.path.join(DATAPATH, "rf_imputed_test_result.csv")
    )
    df_orig = df_orig.assign(
        # pred_class = lambda x: np.where(x['pred_proba'] >= 0.526, 1, 0)
        pred_class=lambda x: np.where(x['pred_proba'] >= 0.59, 1, 0)
    )
    ...
    result.to_csv(
        os.path.join(SAVEPATH, "rf_imputed_results.csv"), 
        index=False
    )
    total_result.append(result)

    df_orig = pd.read_csv(
        os.path.join(DATAPATH, "rf_fev_test_result.csv")
    )
    ...
    result.to_csv(
        os.path.join(SAVEPATH, "rf_fev_results.csv"), 
        index=False
    )
    total_result.append(result)

    df_orig = pd.read_csv(
        os.path.join(DATAPATH, "rf_fev_fvc_test_result.csv")
    )
    ...
    result.to_csv(
        os.path.join(SAVEPATH, "rf_fev_fvc_results.csv"), 
        index=False
    )
    total_result.append(result)

    df_orig = pd.read_csv(
        os.path.join(DATAPATH, "logistic_imputed_test_result.csv")
    )
    ...
    result.to_csv(
        os.path.join(SAVEPATH, "logistic_imputed_results.csv"), 
        index=False
    )
    total_result.append(result)

    df_orig = pd.read_csv(
        os.path.join(DATAPATH, "logistic_fev_test_result.csv")
    )
    print("Logistic FEV")
    result = calculate_bootstrap_metric(
        df_log=df_orig,
    ...
    result.to_csv(
        os.path.join(SAVEPATH, "logistic_fev_results.csv"), 
        index=False
    )
    total_result.append(result)

    df_orig = pd.read_csv(
        os.path.join(DATAPATH, "logistic_fev_fvc_test_result.csv")
    )
    ...
    result.to_csv(
        os.path.join(SAVEPATH, "logistic_fev_fvc_results.csv"), 
        index=False
    )
    total_result.append(result)

    total_result_df = pd.concat(total_result, ignore_index=True)
    total_result_df.to_csv(
        os.path.join(SAVEPATH, "total_results.csv"), 
        index=False
    )
